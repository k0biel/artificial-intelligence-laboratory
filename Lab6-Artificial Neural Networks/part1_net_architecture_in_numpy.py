...
def zad2_two_layer_net(student_id):
    ...
    model.hidden_layer.W[:, 0] = [2, -1]
    model.hidden_layer.W[:, 1] = [-0.75, 0]
    model.hidden_layer.b[:] = [-0.5, 1.75]
    model.output_layer.W[:, 0] = [-0.75, -1]
    model.output_layer.b[:] = [1.75]
...
if __name__ == '__main__':
    ...
    student_id = 193618         # Twój numer indeksu, np. 102247
